...
const Growbuisness = () => {
    return (
        <div>
            <section id="Growbuisness" data-aos={"fade-down"} className="bg-gradient-to-r from-pink-300 to-sky-300 py-10  sm:py-16 ">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="grid items-stretch gap-y-10 md:grid-cols-2 md:gap-x-20">
                        ...
                        <div className="flex flex-col items-start xl:px-16">
                            <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl ">Grow business with Hostinger.</h2>
                            <p className="mt-4 mb-2 text-xl leading-relaxed text-gray-800">Hostinger offers secure and reliable web hosting plans for various website types and online applications. This tutorial will explain how to use Hostinger to succeed in your online journey.

                                We will highlight the unique tools and features that Hostinger provides. You will also learn more about our hosting plans, helping you decide which one is most suitable for you.</p>
